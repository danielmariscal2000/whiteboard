...
function CanvasPruebaSec(props) {
    const firebaseConfig = {
      ...
      async function validarMano(){
        ...
        for(let i=0;i<datos.length;i++){
           if(datos[i].id===props.nombrePizarra){
  ...
  return (
    <CanvasLector mano={props.mano} idUsuario={props.idUsuario} nombrePizarra={props.nombrePizarra} grupo={props.grupo} codigo={props.codigo}></CanvasLector>
  );
}

export default CanvasPruebaSec;