...
import CanvasPruebaSec from "./CanvasPruebaSec.jsx";
export default function CanvasLector(props) {
  let mano=props.mano;
  ...
  async function subirImagen(){
    ...
    const washingtonRef = doc(db, "usuarios", `${idUsu}`);
  ...
  function actualizarPagina(){
    root.render(
      <CanvasPruebaSec mano={mano} idUsuario={idUsu} nombrePizarra={name} grupo={grupo} codigo={codigo}></CanvasPruebaSec>
    );
  }
  // ***********************<<<<<<<<<<<<<<<RETURN CANVAS.JSX>>>>>>>>>>>>>>>>>>>>*************
  return (
      ...
      <button onClick={levantarMano} className="btn-global">Levantar Mano</button>
